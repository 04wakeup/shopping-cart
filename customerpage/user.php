...
while($row=mysqli_fetch_array($result, MYSQLI_ASSOC)) {
			...
			echo "<td>"."<div class='rate-category'>"."
								...
								<input type='hidden' name='order_name' value='".$row['product_id']."'>"."
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$product_id = $POST['order_name'];
	$query2 = "UPDATE SOLD_PRODUCT SET review = '$newreview' WHERE order_id ='$order_id' AND product_id='$product_id';";
	echo "query2";
